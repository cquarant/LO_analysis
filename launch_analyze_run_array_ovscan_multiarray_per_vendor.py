...
usage = "usage: python analysis/launch_analyze_run_array_opt.py --runlist 1,2,3... (only 8V run list, the 4V runs are assumet do be 8V+3) -i /home/cmsdaq/Workspace/TOFPET/Timing-TOFPET/output/TestArray -o /home/cmsdaq/Workspace/TOFPET/Timing-TOFPET/output/TestArray/RESULTS --arraylist 1,2,3..."
